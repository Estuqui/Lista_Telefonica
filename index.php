...
<div class="container"> <!-- classe container mede mais ou menos 80% da página total --> 
   ...
   <!-- <div class= "collapse navbar-collapse" id="conteudonavbarsuportado">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active"><a class="nav-link" href="index.php?menuop=home">Home <i class="bi bi-house-door-fill"></i></li></a>
            <li class="nav-item active"><a class="nav-link" href="index.php?menuop=contatos">Contatos <i class="bi bi-person-lines-fill"></i></li></a>
            <li class="nav-item active"><a class="nav-link" href="index.php?menuop=cadcontato">Novo Contato <i class="bi bi-person-fill-add"></i></a>
