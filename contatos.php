...
<div class="tabela">
    ...
    ?>
            <tr>
                <td> <?php $dados["id"]?></td>
                <td class="text-nowrap"> <?php $dados["nome"]?> </td>
                <td class="text-nowrap"> <?php $dados["sobrenome"]?> </td>
                <td class="text-nowrap"> <?php $dados["email"]?> </td>
                <td class="text-nowrap"> <?php $dados["telefone"]?> </td>

                <td class="text-center">
                    <a class="btn btn-outline-warning btn-sm"
                        href="index.php?menuop=editarcontato&id=<?php $dados["id"]?>"><i
                            class="bi bi-pencil-square"></i></a>
                </td>
                <td class="text-center">
                    <a class="btn btn-outline-danger btn-sm"
                        href="index.php?menuop=excluircontato&id=<?php $dados["id"]?>"><i class="bi bi-trash3"></i></a>
                </td>
            </tr>
